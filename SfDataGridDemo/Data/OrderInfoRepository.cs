...
namespace DetailsView
{
    public class OrderInfoRepository
    {
        ...
        private void EmployeesAdd(int count)
        {
            emp.Add(new Employees(10000, r.Next(1, 10),CustomerID[r.Next(15)]));
            emp.Add(new Employees(10000, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10000, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10000, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10000, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10000, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10000, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10001, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10001, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10001, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10001, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10002, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10002, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10003, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10003, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10003, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10009, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10009, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10010, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10010, r.Next(1, 10), CustomerID[r.Next(15)]));
            emp.Add(new Employees(10010, r.Next(1, 10), CustomerID[r.Next(15)]));
        ...
        private void OrdersAdd(int count)
        {
            ...
            ord.Add(new OrderDetails(10000, 12, 23, 5, 10, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)],getEmployee(10000)));
            ord.Add(new OrderDetails(10000, 14, 59, 10, 2, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10000)));
            ord.Add(new OrderDetails(10000, 18, 23, 5, 10, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10000)));
            ord.Add(new OrderDetails(10000, 34, 59, 10, 2, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10000)));
            ord.Add(new OrderDetails(10000, 14, 59, 10, 2, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10000)));
            ord.Add(new OrderDetails(10000, 18, 23, 5, 10, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10000)));
            ord.Add(new OrderDetails(10000, 34, 59, 10, 2, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10000)));
            ord.Add(new OrderDetails(10001, 23, 45, 76, 0, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10001)));
            ord.Add(new OrderDetails(10001, 45, 67, 23, 5, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10001)));
            ord.Add(new OrderDetails(10001, 45, 42, 16, 3, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10001)));
            ord.Add(new OrderDetails(10001, 23, 95, 15, 2, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10001)));
            ord.Add(new OrderDetails(10002, 7, 70, 6, 4, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10002)));
            ord.Add(new OrderDetails(10002, 2, 30, 5, 2, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10002)));
            ord.Add(new OrderDetails(10003, 23, 73, 9, 3, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10003)));
            ord.Add(new OrderDetails(10003, 8, 11, 8, 7, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10003)));
            ord.Add(new OrderDetails(10003, 1, 150, 1, 0, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10003)));
            ord.Add(new OrderDetails(10009, 4, 35, 4, 0, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10009)));
            ord.Add(new OrderDetails(10009, 2, 31, 7, 0, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10009)));
            ord.Add(new OrderDetails(10010, 7, 23, 3, 0, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10010)));
            ord.Add(new OrderDetails(10010, 5, 65, 4, 0, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10010)));
            ord.Add(new OrderDetails(10010, 3, 15, 5, 0, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10010)));
            ord.Add(new OrderDetails(10010, 2, 31, 1, 0, CustomerID[r.Next(15)], this.OrderedDates[r.Next(count - 1)], getEmployee(10010)));           
        }
        ...
        /// <param name="i">The i.</param>
        /// <returns></returns>
        public List<Employees> getEmployee(int i)
        {
            List<Employees> order = new List<Employees>();
            foreach (var or in emp)
                if (or.OrderID == i)
                    order.Add(or);
            return order;
        }
